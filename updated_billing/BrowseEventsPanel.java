...
public class BrowseEventsPanel extends JPanel {
    ...
    private JPanel createNavBar() {
        ...
        // Main title
        JLabel titleLabel = new JLabel("Browse Events");
    ...
    private void createOrganizerNotification(Connection conn, int organizerId, 
        ...
        String message = String.format(
            "New registration for your event: %s", 
            eventName);
        
        String sql = "INSERT INTO notifications " +
                    "(user_id, notif_message, notif_type, recipient_type, recipient_admin_id, event_registration_id) " +
                    "VALUES (?, ?, ?, 'admin', ?, ?)";
        ...
        try (PreparedStatement stmt = conn.prepareStatement(sql)) {
            ...
            stmt.setInt(5, registrationId); // This sets the event_registration_id column
            stmt.executeUpdate();
        }
    }
    ...
    private void handlePaidEventRegistration(int eventId, double price, String eventName) {
        ...
        int confirm = JOptionPane.showConfirmDialog(
            this,
            String.format("Register for '%s' (RM %.2f)?", eventName, price),
        ...
        try (Connection conn = getConnection()) {
            ...
            try {
                ...
                // Deactivate event if no more seats
                if (newSeatCount == 0) {
                    deactivateEvent(conn, eventId);
                }
    ...
    private void showBilling() {
        ...
        if (window instanceof JFrame) {
            ...
            frame.getContentPane().add(new BillingFeePanel(currentUserId));
            frame.revalidate();
            frame.repaint();
        }
    }
